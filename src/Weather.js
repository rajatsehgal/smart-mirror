  ...
  render() {
    ...
    return (
      <div style={{ marginTop: 30, height: 130 }}>
        <div>
          <i
            style={{ verticalAlign: 'middle', fontSize: 45, color: iconMap[this.state.now.icon].color }}
        ...
        <div style={{ marginTop: 10 }}>
          <i
            style={{ verticalAlign: 'middle', fontSize: 45, color: iconMap[this.state.later.icon].color }}
